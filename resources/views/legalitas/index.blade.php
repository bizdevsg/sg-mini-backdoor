        ...
        <div
            ...
            @if ($legalitasItems->isEmpty())
                ...
                <div class="flex flex-col items-center px-6 py-20 text-center">
                    ...
                    <h3 class="mt-6 text-xl font-semibold text-ivory">Belum ada data legalitas</h3>
            ...
            @else
                ...
                <div
                    ...
                    <p class="text-xs text-smoke">
                        Menampilkan
                        <span
                            class="font-medium text-champagne/80">{{ $legalitasItems->firstItem() }}–{{ $legalitasItems->lastItem() }}</span>
                        dari <span class="font-medium text-champagne/80">{{ $legalitasItems->total() }}</span> dokumen
                        legalitas
                    </p>
                    <div class="text-sm">
