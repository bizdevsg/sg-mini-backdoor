                ...
                <div class="space-y-3 motion-safe:motion-preset-slide-right-sm motion-safe:motion-delay-[60ms]">
                    ...
                    <div>
                        <h1 class="text-2xl font-semibold tracking-[-0.04em] text-ivory lg:text-3xl">
                            Profil
                            <span
                                class="bg-gradient-to-r {{ $theme['gradient_text'] }} bg-clip-text text-transparent">Perusahaan</span>
                        </h1>
                        <p class="mt-2 max-w-xl text-sm leading-6 text-smoke">
                            Kelola identitas resmi perusahaan, visi & misi bilingual, lokasi peta, serta informasi kontak
                            publik.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    @if (filled($complaintLink))
                        <a href="{{ $complaintLink }}" target="_blank" rel="noreferrer"
                            class="inline-flex items-center gap-2 rounded-xl border border-black/10 bg-black/5 px-4 py-2.5 text-sm font-medium text-smoke transition-all duration-200 hover:border-black/18 hover:bg-black/8 hover:text-ivory">
            ...
            <div class="grid gap-6 xl:grid-cols-[minmax(0,1.4fr)_380px]">
                ...
                <div class="space-y-6 motion-safe:motion-preset-slide-right-sm motion-safe:motion-delay-[120ms]">
                    ...
                    <div class="rounded-2xl border border-black/8 bg-black/3 p-6 space-y-5">
                        <div class="flex items-center gap-3 border-b border-black/6 pb-4">
                            <div
                                class="flex h-9 w-9 items-center justify-center rounded-xl border border-gold/20 bg-gold/10 text-gold-soft">
                                <i class="fa-solid fa-building text-sm"></i>
                            </div>
                            <div>
                                <p class="text-[10px] font-semibold uppercase tracking-[0.18em] text-smoke/60">Identitas
                                    Utama</p>
                                <h3 class="text-base font-semibold text-ivory">Profil Perusahaan</h3>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="company_name" name="company_name"
                                    ...
                                    class="w-full rounded-xl border bg-onyx px-4 py-3 text-sm text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('company_name') ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="6"
                                    class="w-full rounded-xl border bg-onyx px-4 py-3 text-sm leading-relaxed text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('description') ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                ...
                                <textarea id="description_en" name="description_en" rows="6"
                                    class="w-full rounded-xl border bg-onyx px-4 py-3 text-sm leading-relaxed text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('description_en') ? 'border-red-400/60' : 'border-black/8' }}"
                    ...
                    <div class="rounded-2xl border border-black/8 bg-black/3 p-6 space-y-5">
                        <div class="flex items-center gap-3 border-b border-black/6 pb-4">
                            ...
                            <div>
                                <p class="text-[10px] font-semibold uppercase tracking-[0.18em] text-smoke/60">Tujuan
                                    Strategis</p>
                                <h3 class="text-base font-semibold text-ivory">Misi Perusahaan</h3>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-5 lg:grid-cols-2">
                            <div>
                                <div class="mb-3 flex items-center justify-between">
                                    <label class="text-xs font-semibold uppercase tracking-[0.14em] text-smoke">Daftar Misi
                                        (ID)</label>
                                    <span
                                        class="rounded-md border border-black/8 bg-onyx px-2 py-0.5 font-mono text-[10px] text-champagne/70">ID</span>
                                </div>
                                <div class="space-y-3">
                                    @foreach ($missionItems as $index => $missionItem)
                                        <div class="relative">
                                            <input type="text" name="mission[]" value="{{ $missionItem }}"
                                                class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('mission') || $errors->has('mission.' . $index) ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                <div class="mb-3 flex items-center justify-between">
                                    <label class="text-xs font-semibold uppercase tracking-[0.14em] text-smoke">Mission List
                                        (EN)</label>
                                    <span
                                        class="rounded-md border border-black/8 bg-onyx px-2 py-0.5 font-mono text-[10px] text-gold-soft">EN</span>
                                </div>
                                <div class="space-y-3">
                                    @foreach ($missionEnItems as $index => $missionEnItem)
                                        <div class="relative">
                                            <input type="text" name="mission_en[]" value="{{ $missionEnItem }}"
                                                class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('mission_en') || $errors->has('mission_en.' . $index) ? 'border-red-400/60' : 'border-black/8' }}"
                    ...
                    <div class="rounded-2xl border border-black/8 bg-black/3 p-6 space-y-5">
                        <div class="flex items-center gap-3 border-b border-black/6 pb-4">
                            ...
                            <div>
                                <p class="text-[10px] font-semibold uppercase tracking-[0.18em] text-smoke/60">Pandangan
                                    Masa Depan</p>
                                <h3 class="text-base font-semibold text-ivory">Visi Perusahaan</h3>
                            </div>
                        </div>
                        ...
                        <div class="grid gap-5 lg:grid-cols-2">
                            <div>
                                <div class="mb-3 flex items-center justify-between">
                                    <label class="text-xs font-semibold uppercase tracking-[0.14em] text-smoke">Daftar Visi
                                        (ID)</label>
                                    <span
                                        class="rounded-md border border-black/8 bg-onyx px-2 py-0.5 font-mono text-[10px] text-champagne/70">ID</span>
                                </div>
                                    ...
                                    @foreach ($visionItems as $index => $visionItem)
                                        <div class="relative">
                                            <input type="text" name="vision[]" value="{{ $visionItem }}"
                                                class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('vision') || $errors->has('vision.' . $index) ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                <div class="mb-3 flex items-center justify-between">
                                    <label class="text-xs font-semibold uppercase tracking-[0.14em] text-smoke">Vision List
                                        (EN)</label>
                                    <span
                                        class="rounded-md border border-black/8 bg-onyx px-2 py-0.5 font-mono text-[10px] text-gold-soft">EN</span>
                                </div>
                                    ...
                                    @foreach ($visionEnItems as $index => $visionEnItem)
                                        <div class="relative">
                                            <input type="text" name="vision_en[]" value="{{ $visionEnItem }}"
                                                class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('vision_en') || $errors->has('vision_en.' . $index) ? 'border-red-400/60' : 'border-black/8' }}"
                ...
                <div class="space-y-6 motion-safe:motion-preset-slide-left-sm motion-safe:motion-delay-[140ms]">
                    ...
                    {{-- KONTAK PERUSAHAAN --}}
                    <div class="rounded-2xl border border-black/8 bg-black/3 p-6 space-y-4">
                        <div class="flex items-center gap-3 border-b border-black/6 pb-4">
                            <div
                                class="flex h-9 w-9 items-center justify-center rounded-xl border border-gold/20 bg-gold/10 text-gold-soft">
                            ...
                            <div>
                                <p class="text-[10px] font-semibold uppercase tracking-[0.18em] text-smoke/60">Kanal Publik
                                </p>
                                <h3 class="text-base font-semibold text-ivory">Kontak Perusahaan</h3>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" id="phone" name="phone"
                                    ...
                                    class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('phone') ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                ...
                                <input type="email" id="email" name="email"
                                    ...
                                    class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('email') ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                ...
                                <input type="text" id="fax" name="fax"
                                    ...
                                    class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('fax') ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                ...
                                <input type="url" id="complaint_link" name="complaint_link"
                                    ...
                                    class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('complaint_link') ? 'border-red-400/60' : 'border-black/8' }}"
                    ...
                    <div class="rounded-2xl border border-black/8 bg-black/3 p-6 space-y-4">
                        <div class="flex items-center gap-3 border-b border-black/6 pb-4">
                            ...
                            <div>
                                <p class="text-[10px] font-semibold uppercase tracking-[0.18em] text-smoke/60">Lokasi Fisik
                                </p>
                                <h3 class="text-base font-semibold text-ivory">Alamat & Maps</h3>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea id="address" name="address" rows="5"
                                    class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs leading-relaxed text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('address') ? 'border-red-400/60' : 'border-black/8' }}"
                            ...
                            <div>
                                ...
                                <input type="url" id="maps_embed_url" name="maps_embed_url"
                                    ...
                                    class="w-full rounded-xl border bg-onyx px-4 py-2.5 text-xs font-mono text-champagne placeholder:text-smoke/40 focus:border-gold/35 focus:outline-none focus:ring-2 focus:ring-gold/12 transition-colors {{ $errors->has('maps_embed_url') ? 'border-red-400/60' : 'border-black/8' }}"
                                    placeholder="https://www.google.com/maps/embed?...">
                                <p class="mt-1.5 text-[11px] text-smoke/60">Gunakan tautan HTML Embed dari Google Maps
                                    (bukan link biasa).</p>
                    ...
                    <div class="overflow-hidden rounded-2xl border border-black/8 bg-black/3">
                        <div class="border-b border-black/6 px-6 py-4">
                            <p class="text-[10px] font-semibold uppercase tracking-[0.18em] text-smoke/60">Live Preview</p>
                            <h3 class="text-sm font-semibold text-ivory">Peta Lokasi Kantor</h3>
                        </div>
                        ...
                        @else
                            <div
                                class="flex h-64 flex-col items-center justify-center gap-2 px-6 text-center text-xs text-smoke/50 bg-onyx/50">
