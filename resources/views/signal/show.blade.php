    ...
    <section class="space-y-6">
        <div class="rounded-[28px] border border-black/8 bg-black/3 px-7 py-6  ">
            <div class="space-y-2">
                ...
                <h1 class="text-2xl font-semibold text-ivory lg:text-3xl">{{ $signal->title_id }}</h1>
                <p class="text-sm text-blue-800/80">{{ $signal->title_en }}</p>
            </div>
        </div>
        ...
        <div class="grid gap-6 lg:grid-cols-[1fr_320px]">
            <div class="space-y-6">
                <article class="rounded-2xl border border-black/8 bg-black/3 p-6">
                    ...
                    <div class="prose max-w-none prose-p:text-sm prose-p:leading-7">
                ...
                <div class="rounded-2xl border border-black/8 bg-black/3 p-5">
                    ...
                    <div class="mt-4 space-y-3 text-sm text-smoke">
                        <div>
                            ...
                            <p class="mt-1 font-medium text-ivory">{{ $signalCategory->name }}</p>
                        </div>
                        <div>
                            <p class="text-xs uppercase tracking-[0.16em] text-smoke/60">Author</p>
                            <p class="mt-1 font-medium text-ivory">{{ $signal->author }}</p>
                        </div>
                        <div>
                            <p class="text-xs uppercase tracking-[0.16em] text-smoke/60">Source</p>
                            <p class="mt-1 font-medium text-ivory">{{ $signal->source }}</p>
                        </div>
                        <div>
