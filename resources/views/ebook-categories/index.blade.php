        ...
        <div
            ...
            @if ($categories->isEmpty())
                ...
                <div class="flex flex-col items-center px-6 py-20 text-center">
                    ...
                    <h3 class="mt-6 text-xl font-semibold text-ivory">Belum ada kategori ebook</h3>
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center justify-end gap-1.5">
                                            <a href="{{ route('ebook.index', $category->slug) }}"
                                                class="inline-flex items-center gap-1.5 rounded-lg border border-black/10 bg-black/5 px-3 py-1.5 text-xs text-nowrap font-medium text-smoke transition-all duration-150 hover:border-black/18 hover:bg-black/8 hover:text-ivory"
