...
@section('content')
    ...
    <section class="space-y-6">
        <div class="relative overflow-hidden rounded-[28px] border border-black/8 {{ $theme['hero_bg'] }} px-7 py-6  ">
            <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                <div class="space-y-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-semibold tracking-[-0.04em] text-ivory lg:text-3xl">Kategori Signal</h1>
        ...
        <div class="rounded-2xl border border-black/8 bg-black/3 px-5 py-4">
            <form action="{{ route('signal-categories.index') }}" method="GET"
        ...
        <div class="overflow-hidden rounded-2xl border border-black/8 bg-black/3">
            @if ($categories->isEmpty())
                <div class="flex flex-col items-center px-6 py-20 text-center">
                    ...
                    <h3 class="mt-6 text-xl font-semibold text-ivory">Belum ada kategori signal</h3>
                        ...
                        <tbody class="divide-y divide-black/5">
                            @foreach ($categories as $category)
                                <tr class="group align-top transition-colors duration-150 hover:bg-black/3">
                                    <td class="px-6 py-4">
                                        <p class="font-semibold text-ivory group-hover:text-blue-700">{{ $category->name }}
                                        </p>
                                    </td>
                                    <td class="px-4 py-4">
                                        <span
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center justify-end gap-1.5">
                                            ...
                                            <form action="{{ route('signal-categories.destroy', $category) }}"
