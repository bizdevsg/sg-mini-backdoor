...
@section('content')
    ...
    <section class="space-y-6">
        ...
        @if ($penghargaans->isEmpty())
            <div
                ...
                <div class="flex flex-col items-center px-6 py-20 text-center">
                    ...
                    <h3 class="mt-6 text-xl font-semibold text-ivory">Belum ada penghargaan</h3>
        ...
        @else
            <div
                class="grid gap-6 md:grid-cols-2 lg:grid-cols-3 motion-safe:motion-preset-slide-up-sm motion-safe:motion-delay-[120ms]">
                    ...
                    <article
                        ...
                        <div>
                            ...
                            <div class="relative overflow-hidden rounded-xl border border-black/8 bg-onyx">
                                ...
                                @else
                                    <div class="flex h-48 items-center justify-center bg-onyx text-sm text-smoke/50">
                                        <i class="fa-solid fa-trophy mr-2 text-base text-gold-soft/50"></i> Gambar tidak
                                        tersedia
                                    </div>
                                @endif
                                ...
                                <div class="absolute right-3 top-3">
                                    <span
                                        class="inline-flex items-center gap-1 rounded-full border border-gold/30 bg-black/75 px-3 py-1 text-[11px] font-semibold text-gold shadow-md backdrop-blur-md">
                            ...
                            <div class="mt-4 space-y-2">
                                <span
                                    class="text-[10px] font-semibold uppercase tracking-[0.2em] text-gold-soft/80">Penghargaan
                                    Resmi</span>
                                <h3
            ...
            <div
                ...
                <p class="text-xs text-smoke">
                    Menampilkan <span
                        class="font-medium text-champagne/80">{{ $penghargaans->firstItem() }}–{{ $penghargaans->lastItem() }}</span>
                    dari
