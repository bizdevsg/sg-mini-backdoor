<div>
    <div class="mb-5 overflow-hidden rounded-2xl border border-white/8 bg-white/3">
        <div class="border-b border-white/6 px-5 py-4">
            <p class="text-sm font-semibold text-white">Cara Kerja Authentication</p>
        ...
        <div class="grid gap-0 divide-y divide-white/6 sm:grid-cols-2 sm:divide-x sm:divide-y-0">
            <div class="px-5 py-4">
    ...
    <div class="space-y-4">
        <div class="overflow-hidden rounded-2xl border border-white/8 bg-white/3">
            ...
            <div class="space-y-3 px-5 py-4">
                <div class="rounded-xl border border-white/8 bg-black/20 px-4 py-3">
                ...
                <div class="rounded-xl border border-white/8 bg-black/20 px-4 py-3 text-xs text-smoke">
        ...
        <div class="overflow-hidden rounded-2xl border border-white/8 bg-white/3">
            <div class="border-b border-white/6 px-5 py-4">
                <p class="text-sm font-semibold text-white">Mobile App</p>
                <p class="mt-1 text-xs leading-5 text-smoke">
            ...
            <div class="space-y-3 px-5 py-4">
                <div class="rounded-xl border border-white/8 bg-black/20 px-4 py-3">
                    ...
                    <div class="mt-2 space-y-1 font-mono text-[11px]">
                        <p class="text-champagne">{{ $apiKeyHeader }}: {{ filled($apiKeyValue) ? $apiKeyValue : 'your-api-key' }}</p>
                        <p class="text-emerald-300">{{ $mobileClientHeader }}: {{ $mobileClientValue }}</p>
                    </div>
                </div>
                <div class="rounded-xl border border-white/8 bg-black/20 px-4 py-3 text-xs text-smoke">
        ...
        <div class="grid gap-4 lg:grid-cols-2">
            <div class="rounded-2xl border border-white/8 bg-white/3 px-5 py-4">
                <p class="text-sm font-semibold text-white">Kapan Website Ditolak</p>
            ...
            <div class="rounded-2xl border border-white/8 bg-white/3 px-5 py-4">
                <p class="text-sm font-semibold text-white">Kapan Mobile App Ditolak</p>
                <div class="mt-3 space-y-3 text-xs leading-5 text-smoke">
