<div>
    <div class="mb-5 overflow-hidden rounded-2xl border border-black/8 bg-black/3">
        <div class="border-b border-black/6 px-5 py-4">
            <p class="text-sm font-semibold text-ivory">Cara Membaca Contoh Request</p>
    ...
    <div class="mb-4 flex items-center gap-3">
        <div
            class="flex h-7 w-7 items-center justify-center rounded-lg border border-orange-500/25 bg-orange-500/15 text-xs font-bold text-orange-700">
            <i class="fa-solid fa-terminal text-[11px]"></i>
        </div>
        <h2 class="text-base font-semibold text-ivory">cURL Examples</h2>
    ...
    <div class="space-y-4">
        @foreach ($requestExamples as $example)
            <div class="overflow-hidden rounded-2xl border border-black/8 bg-[#120f0c]">
                <div class="flex items-center justify-between gap-3 border-b border-black/6 bg-[#1b1611] px-4 py-2.5">
                    ...
                    <button type="button" data-copy-button data-copy-text="{{ $example['command'] }}"
                        ...
                        class="inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-[11px] font-medium text-white/70 transition-colors hover:border-white/18 hover:bg-white/8 hover:text-white">
                        <i class="fa-regular fa-copy text-[10px]"></i>
                        <span data-copy-label>Copy</span>
                    </button>
                </div>
                <pre class="overflow-x-auto whitespace-pre-wrap break-all px-4 py-4 font-mono text-[11px] leading-6 text-white/90"><code>{{ $example['command'] }}</code></pre>
            </div>
        @endforeach

        <div class="rounded-2xl border border-black/8 bg-black/3 px-5 py-4">
            <p class="text-sm font-semibold text-ivory">Response Error yang Perlu Diketahui</p>
            <div class="mt-3 space-y-2 text-xs text-smoke">
                <p><span class="font-mono text-rose-700">403</span> - API key tidak valid.</p>
                <p><span class="font-mono text-rose-700">403</span> - Allowed Origin Frontend belum dikonfigurasi untuk web client.</p>
                <p><span class="font-mono text-rose-700">403</span> - Header Origin wajib dikirim untuk web client.</p>
                <p><span class="font-mono text-rose-700">403</span> - Origin frontend tidak diizinkan.</p>
                <p><span class="font-mono text-amber-700">503</span> - Public API sedang dinonaktifkan.</p>
            </div>
        </div>

        <div class="grid gap-4 lg:grid-cols-2">
            <div class="rounded-2xl border border-black/8 bg-black/3 px-5 py-4">
                <p class="text-sm font-semibold text-ivory">Cara Test dari Terminal</p>
            ...
            <div class="rounded-2xl border border-black/8 bg-black/3 px-5 py-4">
                <p class="text-sm font-semibold text-ivory">Cara Ubah ke Postman</p>
                <div class="mt-3 space-y-3 text-xs leading-5 text-smoke">
