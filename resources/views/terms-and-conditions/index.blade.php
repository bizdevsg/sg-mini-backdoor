...
@section('content')
    ...
    <section class="space-y-6">
                ...
                <div class="space-y-3 motion-safe:motion-preset-slide-right-sm motion-safe:motion-delay-[60ms]">
                    ...
                    <div>
                        ...
                        <p class="mt-2 max-w-2xl text-sm leading-6 text-smoke">
                            ...
                            halaman ini terpusat pada satu record.
                        </p>
                    </div>
                </div>
                ...
                <div
                    ...
                    @if ($terms?->updated_at)
                        <span class="rounded-xl border border-gold/20 bg-gold/8 px-4 py-2.5 text-sm text-gold-soft">
                            Update {{ $terms->updated_at->format('d M Y H:i') }}
                        </span>
                    @endif
                </div>
            </div>
        ...
        <form action="{{ route('terms-and-conditions.update') }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="rounded-2xl border border-black/8 bg-black/3 p-6 space-y-5">
                    <div class="flex items-center gap-3 border-b border-black/6 pb-4">
                        ...
                        <div>
                            ...
                            <h3 class="text-base font-semibold text-ivory">Isi Syarat dan Ketentuan</h3>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-6">
                        <div>
                            <label for="content"
                                ...
                                Konten Syarat dan Ketentuan (ID) <span class="text-gold-soft">*</span>
                            </label>
                            <x-forms.tinymce-editor id="content" name="content" :value="$content" :height="750"
                                placeholder="Masukkan seluruh isi syarat dan ketentuan..."
                        ...
                        <div>
                            <label for="content_en"
                                class="mb-2 block text-xs font-semibold uppercase tracking-[0.16em] text-smoke">
                                Terms and Conditions Content (EN)
                            </label>
                            <x-forms.tinymce-editor id="content_en" name="content_en" :value="$contentEn" :height="750"
                                placeholder="Write the English version of the terms and conditions..."
